...
class GreekMorphoConverter:
    ...
    def __init__(self):
        self.csv_columns = [
            ...
            'person', 'number', 
            'voice', 'mood', 'tense', 
            'gloss', 'clause_role', 'semantic_role', 'syntactic_head'
        ]
    ...
    def extract_token_data(self, sentence: Dict[str, Any]) -> List[Dict[str, Any]]:
        ...
        for i, token_data in enumerate(sentence['analysis'], 1):
            ...
            token_row = {
                ...
                'clause_role': token_data.get('clause_role', ''),
                'semantic_role': token_data.get('semantic_role', ''),
                'syntactic_head': token_data.get('syntactic_head', '')
            }
